...
def gameWindow():
    ...
    canvas2 = Canvas( gameWindow, width = 50,height = 50)
    ...
    # Add Text
    canvas2.create_text( screen_width/2 + 25,50, text = "Tambola Family Fun", font=("Chalkboard SE",50), fill="#3e2723")
    ...
    # Flash Number Label
    flashNumberLabel = canvas2.create_text(400,500, text = "Waiting for other players to join...", font=("Chalkboard SE",30), fill="#3e2723")
...
def askPlayerName():
    ...
    nameEntry.place(x = screen_width/7 + 20, y=screen_height/5.5 + 50 )

    button = tk.Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=11, command=saveName, height=2, bg="red", bd=3)
    button.place(x = screen_width/7 + 20, y=screen_height/2 + 50)
